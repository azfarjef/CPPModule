...
/*   Updated: 2022/12/09 16:39:51 by mahmad-j         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	Bureaucrat::signForm(Form &F)
{
	...
	{
		F.beSigned(*this);
		std::cout << this->_name << ", " << this->_grade << " signed " << F.getName() << std::endl;
	}
	catch(Form::Exception &e)
	{
		std::cerr << this->_name << ", " << this->_grade << " couldn’t sign " << F.getName() << " <form> because " << e.what() << '\n';
	}
}
